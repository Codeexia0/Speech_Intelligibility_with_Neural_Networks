...
# Load the dataset
data = pd.read_csv('CNNNetwork_fold_3_20250215_153013.csv')

# Extract true and predicted intelligibility values and convert to percentage (0-100)
predicted_intelligibility = np.clip(data['Predicted'], 0, 1) * 100
true_intelligibility = np.clip(data['Expected'], 0, 1) * 100
